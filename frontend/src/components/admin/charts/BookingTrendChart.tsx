    ...
    return (
        <div className="w-full rounded-2xl border border-primary/10 bg-white/45 p-3">
            <div className="mb-2 flex items-start justify-between gap-2">
                <div>
                    <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-text">Booking Trend Graph</h4>
                    <p className="text-[9px] font-bold text-text/50 uppercase tracking-wider">Daily Booking Movement</p>
                </div>
            ...
            {data.length === 0 && (
                <p className="mt-1 text-[9px] font-bold text-text/50 uppercase tracking-wider">No booking trend data available</p>
            )}
        </div>
    );
};
